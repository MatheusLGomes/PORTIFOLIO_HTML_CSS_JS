...
<main class="form-login">
    <form action="" method="post">
        <img class="mb-4" src="images/pib.jpeg" alt="" width="100" height="100">
    </form>
    <h5>PIB</h5>

    <form action="insertPIB.php" method="post">
        ...
        <div  class="form-floating mb-3">
         ...
         <div>
            ...
            <form action="chartPIB.php" method="get">
