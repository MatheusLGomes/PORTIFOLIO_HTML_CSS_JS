...
<main class="form-login">
    <form action="" method="post">
        <img class="mb-4" src="images/dolar.jpeg" alt="" width="100" height="100">
    </form>
    <h5>SALÁRIO X DÓLAR<h5>

    <form action="insert.Dolar.php" method="post">
        ...
        <div  class="form-floating mb-3">
         ...
         <div>
            ...
            <form action="chartDolar.php" method="get">
