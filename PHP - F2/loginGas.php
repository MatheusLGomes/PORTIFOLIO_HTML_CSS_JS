...
<main class="form-login">
    <form action="insertGas.php" method="post">
        <img class="mb-4" src="images/gasol.jpeg" alt="" width="100" height="100">
    </form>
    <h5>SALÁRIO X LITRO DE GASOLINA</h5>
    ...
    <form action="insertGas.php" method="post">
        ...
        <div  class="form-floating mb-3">
         ...
         <div>
            ...
            <form action="chartGas.php" method="get">
